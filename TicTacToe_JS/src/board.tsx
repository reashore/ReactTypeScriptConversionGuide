...
export class Board extends React.Component<{}, BoardState> {
  ...
  private checkGameState(cells: CellValue[], latestPos: number, latestVal: CellValue) {
  ...
  private move(pos: number, val: CellValue, callback?: () => void): void {
    if (this.state.gameState === "" && this.state.cells[pos] === "") {
      ...
      this.setState(
        { cells: newCells, gameState: this.checkGameState(newCells, pos, val) },
        () => {
